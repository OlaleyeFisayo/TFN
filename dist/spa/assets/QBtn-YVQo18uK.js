...
const U = '0 0 24 24',
  ...
  xe = new RegExp('^(' + Object.keys(ie).join('|') + ')'),
  qe = new RegExp('^(' + Object.keys(le).join('|') + ')'),
  X = new RegExp('^(' + Object.keys(oe).join('|') + ')'),
  $e = /^[Mm]\s?[-+]?\.?\d/,
  Ee = /^img:/,
  Se = /^svguse:/,
  we = /^ion-/,
  Re = /^(fa-(classic|sharp|solid|regular|light|brands|duotone|thin)|[lf]a[srlbdk]?) /,
  Y = V({
    name: 'QIcon',
    props: {
      ...re,
    ...
    setup(e, { slots: t }) {
      const {
        ...
        f = s(() => {
          ...
          if (a.iconMapFn !== null) {
            const o = a.iconMapFn(u)
            if (o !== void 0)
              if (o.icon !== void 0) {
                if (((u = o.icon), u === 'none' || !u)) return { none: !0 }
          ...
          if (Ee.test(u) === !0) return { img: !0, src: u.substring(4) }
          if (Se.test(u) === !0) {
            const [o, y = U] = u.split('|')
          ...
          else if (Re.test(u) === !0) c = u
          else if (we.test(u) === !0)
            c = `ionicons ion-${a.platform.is.ios === !0 ? 'ios' : 'md'}${u.substring(3)}`
          else if (X.test(u) === !0) {
            c = 'notranslate material-symbols'
            const o = u.match(X)
            o !== null && ((u = u.substring(6)), (c += oe[o[1]])), (q = u)
          } else {
            c = 'notranslate material-icons'
            const o = u.match(qe)
            o !== null && ((u = u.substring(2)), (c += le[o[1]])), (q = u)
          }
          return { cls: c, content: q }
        })
      return () => {
        const c = { class: l.value, style: n.value, 'aria-hidden': 'true', role: 'presentation' }
        return f.value.none === !0
          ? v(e.tag, c, pe(t.default))
          : f.value.img === !0
            ...
            : f.value.svg === !0
              ? v(
                  ...
                  c,
                  z(t.default, [
                    v('svg', { viewBox: f.value.viewBox || '0 0 24 24' }, f.value.nodes),
                  ]),
                )
              : f.value.svguse === !0
                ? v(
  ...
  Le = { size: { type: [String, Number], default: '1em' }, color: String }
function Be(e) {
  return {
...
function Z(e, t, a, n) {
  ...
  const c = document.createElement('span'),
    ...
    q = ge(e),
    { left: h, top: o, width: y, height: i } = t.getBoundingClientRect(),
    k = Math.sqrt(y * y + i * i),
    b = k / 2,
    p = `${(y - k) / 2}px`,
    d = f ? p : `${q.left - h - b}px`,
...
function G(e, { modifiers: t, value: a, arg: n }) {
...
const Te = de({
    ...
    updated(e, t) {
      if (t.oldValue !== t.value) {
        const a = e.__qripple
        a !== void 0 &&
          ((a.enabled = t.value !== !1), a.enabled === !0 && Object(t.value) === t.value && G(a, t))
      }
    },
    beforeUnmount(e) {
      const t = e.__qripple
  ...
  Me = Object.keys(se),
  Oe = { align: { type: String, validator: (e) => Me.includes(e) } }
function Ae(e) {
  return s(() => {
...
function ze(e, t) {
  for (const a in t) {
    ...
    if (typeof n == 'string') {
      if (n !== l) return !1
    } else if (Array.isArray(l) === !1 || l.length !== n.length || n.some((f, c) => f !== l[c]))
      return !1
  }
  return !0
}
...
function De({ fallbackTag: e, useDisableForRouterLinkProps: t = !0 } = {}) {
  const a = F(),
    ...
    q =
      t === !0
        ...
        : s(() => c === !0 && u.value !== !0 && n.to !== void 0 && n.to !== null && n.to !== ''),
    h = s(() => (q.value === !0 ? _(n.to) : null)),
    o = s(() => h.value !== null),
    y = s(() => u.value === !0 || o.value === !0),
    i = s(() => (n.type === 'a' || y.value === !0 ? 'a' : n.tag || e || 'div')),
    k = s(() =>
      u.value === !0
    ...
    b = s(() => {
      ...
      const L = R.findIndex(ee.bind(null, S))
      if (L !== -1) return L
      const K = J(g[$ - 2])
      return $ > 1 && J(S) === K && R[R.length - 1].path !== K
        ? R.findIndex(ee.bind(null, g[$ - 2]))
        : L
    }),
    p = s(() => o.value === !0 && b.value !== -1 && ze(l.$route.params, h.value.params)),
    d = s(
      () =>
        p.value === !0 &&
  ...
  function B(g, { returnRouterError: $, to: S = n.to, replace: R = n.replace } = {}) {
    ...
    g.preventDefault()
    const L = l.$router[R === !0 ? 'replace' : 'push'](S)
    return $ === !0 ? L : L.then(() => {}).catch(() => {})
  }
  function C(g) {
    if (o.value === !0) {
      const $ = (S) => B(g, S)
...
const ne = { none: 0, xs: 4, sm: 8, md: 16, lg: 24, xl: 32 },
  ...
  Fe = /[^\s]\/[^\s]/,
  He = ['flat', 'outline', 'push', 'unelevated']
function Ue(e, t) {
  return e.flat === !0
    ? 'flat'
    : e.outline === !0
...
function Ye(e) {
  const t = ue(e, Qe),
    ...
    h = s(() => e.rounded === !0 || e.fab === !0 || e.fabMini === !0),
      ...
      return (
        ...
        f.value === 'a'
          ? (e.disable === !0
            ...
            n.value !== !0 && Fe.test(e.type) === !0 && (d.type = e.type))
...
const Je = V({
  name: 'QBtn',
  props: { ...Xe, percentage: Number, darkPercentage: Boolean, onTouchstart: [Function, Array] },
  ...
  setup(e, { slots: t, emit: a }) {
          ...
          if (
            ...
            const I = () => {
              document.removeEventListener('keydown', P, !0),
                ...
                i.value !== null && i.value.removeEventListener('blur', I, E)
            }
    ...
    function w(r) {
      if (
        i.value !== null &&
        !(r !== void 0 && r.type === 'blur' && document.activeElement === i.value)
      ) {
        if (r !== void 0 && r.type === 'keyup') {
          if (M === i.value && D(r, [13, 32]) === !0) {
    ...
    function A(r) {
      ...
      r !== !0 &&
        ...
        T === i.value &&
          (b !== null &&
            (b.removeEventListener('touchcancel', w, E), b.removeEventListener('touchend', w, E)),
          (T = b = null)),
        O === i.value && (document.removeEventListener('mouseup', w, E), (O = null)),
        M === i.value &&
          (document.removeEventListener('keyup', w, !0),
          i.value !== null && i.value.removeEventListener('blur', w, E),
          (M = null)),
    ...
    return (
      ...
      () => {
        let r = []
        e.icon !== void 0 &&
          r.push(v(Y, { name: e.icon, left: e.stack !== !0 && x.value === !0, role: 'img' })),
          x.value === !0 && r.push(v('span', { class: 'block' }, [e.label])),
          (r = z(t.default, r)),
          e.iconRight !== void 0 &&
            e.round === !1 &&
            r.push(
              v(Y, { name: e.iconRight, right: e.stack !== !0 && x.value === !0, role: 'img' }),
            )
          ...
          e.loading === !0 &&
            ...
            m.push(
              v(
                ...
                [v('span', { class: 'q-btn__progress-indicator fit block', style: C.value })],
              ),
            ),
          m.push(
            v(
                ...
                e.loading === !0
                  ? [
                      v(
                        ...
                        t.loading !== void 0 ? t.loading() : [v(Ce)],
                      ),
                    ]
                  : null,
              ),
            ),
          he(v(h.value, $.value, m), [[Te, _.value, void 0, B.value]])
        )
      }
    )
  },
})
export { Je as Q, z as a, Y as b, _e as c, ue as d, Ce as e, Ge as g, pe as h, re as u }
