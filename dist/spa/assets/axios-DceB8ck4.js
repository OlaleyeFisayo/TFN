import { j as Ze } from './index-croNHMG4.js'
function Pe(e, t) {
  return function () {
...
const nt = v('string'),
  ...
  [ft, dt, pt, ht] = ['ReadableStream', 'Request', 'Response', 'Headers'].map(C),
...
function re() {
  ...
  for (let r = 0, s = arguments.length; r < s; r++) arguments[r] && I(arguments[r], n)
  return t
}
const yt = (e, t, n, { allOwnKeys: r } = {}) => (
  ...
  me = '0123456789',
  Ue = { DIGIT: me, ALPHA: Y, ALPHA_DIGIT: Y + Y.toUpperCase() + me },
...
const Ut = (e) => {
  ...
  Dt = C('AsyncFunction'),
  kt = (e) => e && (X(e) || x(e)) && x(e.then) && x(e.catch),
  De = ((e, t) =>
    e
      ? setImmediate
      : t
        ...
        : (n) => setTimeout(n))(typeof setImmediate == 'function', x(L.postMessage)),
  jt =
...
function G(e, t, n) {
        ...
        return (
          ...
          w.forEach(function (S, N) {
            !(a.isUndefined(S) || S === null) &&
              t.append(i === !0 ? ye([y], N, o) : i === null ? y : y + '[]', u(S))
          }),
          !1
        )
    }
  ...
  const d = [],
    b = Object.assign(Ht, { defaultVisitor: l, convertValue: u, isVisitable: se })
  function R(p, y) {
    if (!a.isUndefined(p)) {
      ...
      d.push(p),
        a.forEach(p, function (w, g) {
          ;(!(a.isUndefined(w) || w === null) &&
            s.call(t, w, a.isString(g) ? g.trim() : g, y, b)) === !0 && R(w, y ? y.concat(g) : [g])
        }),
        d.pop()
    }
  }
...
function He(e, t, n) {
  ...
  let o
  if (
    (s ? (o = s(t, n)) : (o = a.isURLSearchParams(t) ? t.toString() : new le(t, n).toString(r)), o)
  ) {
    const i = e.indexOf('#')
...
const Me = { silentJSONParsing: !0, forcedJSONParsing: !0, clarifyTimeoutError: !1 },
  ...
  Vt = {
    isBrowser: !0,
    classes: { URLSearchParams: zt, FormData: Jt, Blob: $t },
    protocols: ['http', 'https', 'file', 'blob', 'url', 'data'],
  },
  fe = typeof window < 'u' && typeof document < 'u',
  oe = (typeof navigator == 'object' && navigator) || void 0,
  Wt = fe && (!oe || ['ReactNative', 'NativeScript', 'NS'].indexOf(oe.product) < 0),
  Kt =
    typeof WorkerGlobalScope < 'u' &&
    self instanceof WorkerGlobalScope &&
    typeof self.importScripts == 'function',
  vt = (fe && window.location.href) || 'http://localhost',
  Xt = Object.freeze(
...
const We = (e) => {
        ...
        'onloadend' in h
          ...
          (h.ontimeout = function () {
            ...
            s.timeoutErrorMessage && (N = s.timeoutErrorMessage),
              r(new m(N, T.clarifyTimeoutError ? m.ETIMEDOUT : m.ECONNABORTED, e, h)),
              (h = null)
          }),
          o === void 0 && i.setContentType(null),
          'setRequestHeader' in h &&
            a.forEach(i.toJSON(), function (N, T) {
  ...
  Ke = Q && typeof ReadableStream == 'function',
  Rn =
    Q &&
  ...
  Te = 64 * 1024,
  ie = Ke && ve(() => a.isReadableStream(new Response('').body)),
  W = { stream: ie && ((e) => e.body) }
Q &&
  ((e) => {
...
const Sn = async (e) => {
    ...
    if ((a.isURLSearchParams(e) && (e = e + ''), a.isString(e))) return (await Rn(e)).byteLength
  },
  On = async (e, t) => {
  ...
  Tn =
    ...
    (async (e) => {
      ...
      let R = yn([s, o && o.toAbortSignal()], i),
        p
      const y =
        R &&
        R.unsubscribe &&
      ...
      let h
      try {
        if (f && gn && n !== 'get' && n !== 'head' && (h = await On(l, r)) !== 0) {
          let T = new Request(t, { method: 'POST', body: r, duplex: 'half' }),
            _
          if (
            (a.isFormData(r) && (_ = T.headers.get('content-type')) && l.setContentType(_), T.body)
          ) {
            const [F, M] = Re(h, V(ge(f)))
            r = Oe(T.body, Te, F, M)
          }
        }
        ...
        if (ie && (c || (S && y))) {
          ...
          const _ = a.toFiniteNumber(g.headers.get('content-length')),
            [F, M] = (c && Re(_, V(ge(c), !0))) || []
          g = new Response(
            Oe(g.body, Te, F, () => {
              M && M(), y && y()
        ...
        u = u || 'text'
        let N = await W[a.findKey(W, u) || 'text'](g, e)
        return (
          !S && y && y(),
...
function xe(e) {
  return (
    ...
    Xe.getAdapter(e.adapter || H.adapter)(e).then(
      function (r) {
        return (
          ne(e), (r.data = te.call(e, e.transformResponse, r)), (r.headers = A.from(r.headers)), r
        )
      },
      function (r) {
        return (
...
const $ = { assertOptions: xn, validators: Z },
  P = $.validators
class B {
  constructor(t) {
    ...
    r !== void 0 &&
      ...
      s != null &&
        (a.isFunction(s)
          ...
          : $.assertOptions(s, { encode: P.function, serialize: P.function }, !0)),
      $.assertOptions(
        n,
...
E.HttpStatusCode = ce
E.default = E
const Nn = E.create({ baseURL: 'https://api.example.com' }),
  Fn = Ze(({ app: e }) => {
    ;(e.config.globalProperties.$axios = E), (e.config.globalProperties.$api = Nn)
  })
